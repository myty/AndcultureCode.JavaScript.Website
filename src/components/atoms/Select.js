        ...
        return (
            <fieldset className = { this.props.className }>
                ...
                <div className = { selectClassName }>
                    <select id={this.props.id} name={this.props.name} { ...selectProps } onChange = { this._updateInputValue } onBlur = { this._disableField } onFocus = { this._activateField } defaultValue="default">
