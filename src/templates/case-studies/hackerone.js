                ...
                <div className = "o-rhythm__container">
                    <div className = "m-case-study-page-content__copy-section -body-intro">
                        ...
                        <div className = "o-rhythm__row">
                            ...
                            <div className = "content__easter-egg easter-egg">Turns out that’s a pretty broad geography— 122 countries and counting.
</div>
                        </div>
                    </div>
                </div>
                ...
                <div className = "o-rhythm__container">
                    <div className = "m-case-study-page-content__copy-section -mobile-padding__top-none">
                        ...
                        <div className = "o-rhythm__row">
                            ...
                            <div className = "content__copy">
                                <p>Analog and digital, we’re designing for all aspects of h1’s live-hacking events. We help HackerOne promote all the live hacking events, Security@ and their presence at many other trade shows, including InfoSecurity, GES, Black Hat, Money 20/20, Gartner Security &amp; Risk Management and DEFCON, on social media.</p>
                            </div>
                        </div>
                    </div>
                </div>
